...
# LoRA hyperparameters in peft.py are not used for “training” in EoRA, but rather:
# Serve as configuration specification defining EoRA low-rank matrix core parameters (e.g., rank, target modules);
# Through parameter validation ensure correctness of EoRA logic;
# Maintain compatibility with Hugging Face PEFT ecosystem
