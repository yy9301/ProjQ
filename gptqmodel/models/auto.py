...
# This is only producing a compensation-style adapter like EoRA, not training
    class adapter:
        @classmethod
        def generate(
            cls,
            ...
            # Use find_modules to filter all TorchQuantLinear layers from the quantized model
            # These layers are the original linear layers replaced by GPTQ quantization (e.g., q_proj, v_proj, o_proj in attention, and up_proj, down_proj in FFN)
