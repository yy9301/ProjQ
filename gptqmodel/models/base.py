...
class BaseQModel(nn.Module):
    ...
    def quantize(
        ...
        elif self.quantize_config.quant_method == METHOD.PROJQ:
            from ..looper.projq_processor import ProjQProcessor  # You need to implement this Processor yourself
            quantize_processor = [
                TensorParallelWeightProcessor(**args),
                ProjQProcessor(**args),
            ]
        # elif self.quantize_config.quant_method == METHOD.GPTQLoRA:
        #     from ..looper.projq_processor import ProjQProcessor  # You need to implement this Processor yourself
        #     # ProjQProcessor interface is consistent with GPTQProcessor
        #     quantize_processor = [
        #         TensorParallelWeightProcessor(**args),
        #         ProjQProcessor(**args),
        #     ]
