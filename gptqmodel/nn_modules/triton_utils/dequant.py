...
def dequant_kernel(
    ...
    if bits == 3:
        ...
        # Use tl.where instead of if branch (avoid tensor conditional)
        ...
        # zeros = tl.where(zero_bit_offset <= 29, (zero_word >> zero_bit_offset) & 0b111, combined & 0b111)
    ...
    if bits == 3:
        ...
        # Key change: use tl.where instead of if branch (avoid tensor conditional)
        ...
        # weights = tl.where(weight_bit_offset <= 29, (weight_word >> weight_bit_offset) & 0b111, combined & 0b111)
        Handle case where 3-bit value is fully within current 32-bit word
