...
# Define prompt builder functions for each task
...
def main():
    ...
    parser.add_argument("--comp_method", type=str, default="eora", choices=["eora", "lordq"],
                        help="Compensation method (eora / lordq)")
    ...
    quantized_model.quantize_config.comp_method = args.comp_method
